    ...
    public partial class Form2 : Form
    {
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            if (!button13Clicked)
            {
                ...
                {
                    // The content of textBox14 can be parsed into an integer
                    text1 += label3.Text + "   " + textBox13.Text + "x" + Environment.NewLine;
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            if (!button12Clicked)
            {
                ...
                {
                    // The content of textBox14 can be parsed into an integer
                    text1 += label2.Text + "   " + textBox12.Text + "x" + Environment.NewLine;
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            if (!button11Clicked)
            {
                ...
                {
                    // The content of textBox14 can be parsed into an integer
                    text1 += label5.Text + "   " + textBox11.Text + "x" + Environment.NewLine;
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (!button10Clicked)
            {
                ...
                {
                    // The content of textBox14 can be parsed into an integer
                    text1 += label4.Text + "   " + textBox10.Text + "x" + Environment.NewLine;
