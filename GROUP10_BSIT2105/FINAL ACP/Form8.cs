    ...
    public partial class Form8 : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (!button8Clicked)
            {
                ...
                {
                    // The content of textBox14 can be parsed into an integer
                    text1 += label8.Text + "   " + textBox7.Text + "x" + Environment.NewLine;
                    button8Clicked = true; // Set the flag to true after the first click
                }
                else
                {
                    // Show an error message
                    MessageBox.Show("Please enter a valid integer in textBox8.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
